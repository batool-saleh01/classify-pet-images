...
txt_path = os.path.join(directory_of_this_script, "imagenet1000_clsid_to_human.txt")
resnet18 = model = models.resnet50(weights='ResNet50_Weights.DEFAULT')
...
with open(txt_path, "r") as imagenet_classes_file:
